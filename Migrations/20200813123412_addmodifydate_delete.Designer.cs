...
namespace ASPcore3Homework.Migrations
{
    ...
    [Migration("20200813123412_addmodifydate_delete")]
    partial class addmodifydate_delete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.Course", b =>
                {
                    b.HasOne("ASPcore3Homework.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.CourseInstructor", b =>
                {
                    b.HasOne("ASPcore3Homework.Models.Course", "Course")
                    ...
                    b.HasOne("ASPcore3Homework.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("ASPcore3Homework.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("ASPcore3Homework.Models.OfficeAssignment", b =>
                {
                    b.HasOne("ASPcore3Homework.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("ASPcore3Homework.Models.OfficeAssignment", "InstructorId")
